...
namespace KitKap.Service.Services
{
    public class AccountService : IAccountService
    {
        ...
        public async Task<GetByIdUserViewModel> FindById(string id)
        {
            ...
            return _mapper.Map<GetByIdUserViewModel>(user);
        }

        public async Task<List<RequestUserViewModel>> GetAllUsersAsync()
        {
            var users = await _userManager.Users.ToListAsync();
            return _mapper.Map<List<RequestUserViewModel>>(users);
        }

        public async Task<AuthResponse> LoginAsync(LoginUserViewModel model)
        {
        ...
        public async Task DeactivateUserAsync(DeactivateUserViewModel model)
        {
